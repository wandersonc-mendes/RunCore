...
function Field({ label, name, data, setData, type = "text", ...inputProps }) {
  return <label>{label}<input {...inputProps} type={type} value={data[name] || ""} onChange={(event) => setData({ ...data, [name]: event.target.value })} /></label>;
}
